...
<p  className='text2'> Lidar com sons altos pode ser particularmente desafiador para pessoas autistas, mas algumas estratégias podem ajudar a minimizar o desconforto:</p>

</div>

<div className='colunas'>
<button  className='protetores'><h4 className="p">Protetores auriculares</h4></button><br />
<button  className='Espa-Tranq'><h4 className="p2">Espaços tranquilos</h4></button><br/>
<button  className='Planejamento'><h4 className="p3">Planejamento</h4></button><br/>
<button  className='Comunicaçãos'><h4 className="p4">Comunicação</h4></button><br/>
<button  className='tec-relax'><h4 className="p5">Técnicas de relaxamento</h4></button><br/>
<button  className='Mús-Rui-Branco'><h4 className="p6">Técnicas de relaxamento</h4></button><br/>
<button  className='Treinamento-Dessens'><h4 className="p7">Treinamento de dessensibilização</h4></button><br/>
