...
function Tela_Informacoes() {
 ...
 <h2 className='TEA'>Informações sobre o TEA:</h2>
     ...
     <p className='Tra'>O Transtorno do Espectro Autista (TEA) é uma condição neurológica que afeta o desenvolvimento social e comportamental das pessoas.
     ...
     <p className='Tra'>Informações sobre o TEA: <br /> O TEA é um espectro, o que significa que abrange uma ampla gama de manifestações. As pessoas com TEA 
     ...
     <p className='Tra'>Características do TEA: <br /> Comunicação: Algumas pessoas com TEA podem ter dificuldades na linguagem verbal e não verbal, enquanto 
     ...
     <p className='Tra'>Curiosidades sobre o TEA <br /> Gênios do Espectro: Muitas pessoas com TEA possuem habilidades excepcionais em áreas como matemática, música
