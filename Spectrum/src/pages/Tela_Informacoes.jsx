...
function Tela_Informacoes() {
 ...
 <h2>Informações sobre o TEA:</h2>
     ...
     <p>O Transtorno do Espectro Autista (TEA) é uma condição neurológica que afeta o desenvolvimento social e comportamental das pessoas.
        Cada indivíduo com TEA é único, apresentando uma combinação distinta de características e habilidades. Aqui estarão citadas algumas 
        informações, características e curiosidades sobre o TEA: <br /><br /> </p>
     <p>Informações sobre o TEA: <br /> O TEA é um espectro, o que significa que abrange uma ampla gama de manifestações. As pessoas com TEA 
     ...
     <p>Características do TEA: <br /> Comunicação: Algumas pessoas com TEA podem ter dificuldades na linguagem verbal e não verbal, enquanto 
     ...
     <p>Curiosidades sobre o TEA <br /> Gênios do Espectro: Muitas pessoas com TEA possuem habilidades excepcionais em áreas como matemática, música
      ou arte. Um exemplo famoso é o cientista Temple Grandin, que revolucionou a indústria de manejo de gado. <br /> Diversidade: O TEA é mais comum
       ...
       <p>Cada pessoa com TEA tem um conjunto único de desafios e talentos. Com o suporte adequado, elas podem levar vidas plenas e produtivas, 
